DROP TABLE IF EXISTS model_stg.segment_rules;

CREATE TABLE IF NOT EXISTS model_stg.segment_rules
(
...
INSERT INTO model_stg.segment_rules VALUES ('frequent_segment', '0-4', 0, 4),
